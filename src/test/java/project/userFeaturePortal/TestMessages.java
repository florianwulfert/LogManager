...
public class TestMessages {
    ...
    public static final String HAYA = "{\"id\":8,\"titel\":\"haya\",\"erscheinungsjahr\":1998}";
    public static final String PETRA_BOOK = "{\"id\":9,\"titel\":\"petra\",\"erscheinungsjahr\":1999}";
  ...
  public static final String PETRA_TORSTEN_HANS =
      "{\"result\":[{\"id\":1,\"name\":\"Petra\",\"birthdate\":\"1999-12-13\","
          + "\"weight\":65.0,\"height\":1.6,\"bmi\":25.39}"
          + ",{\"id\":2,\"name\":\"Torsten\",\"birthdate\":\"1985-12-05\",\"weight\":61.3,\"height\":1.83,"
          + "\"bmi\":18.3},"
          + "{\"id\":3,\"name\":\"Hans\",\"birthdate\":\"1993-02-03\",\"weight\":75.7,\"height\":1.85,"
          + "\"bmi\":22.11}],\"returnMessage\":null}";
  ...
  public static final String ID_NOT_EXISTS =
      "No class project.userFeaturePortal.model.entity.Log entity with id 20 exists!";
  ...
  public static final String PETRA_BOOK =
      "{\"id\":25,\"titel\":\"petra\",\"erscheinungsjahr\":1999}";
  public static final String ID_FOR_BOOK_HAS_WRONG_FORMAT =
      "Required path variable was not found or request param has wrong format! "
          + "Failed to convert value of type 'java.lang.String' to required type 'java.lang.Integer'; "
          + "nested exception is java.lang.NumberFormatException: For input string: \"kevin\"";
  public static final String USER_CREATED_MESSAGE =
      "{\"result\":[{\"id\":1,\"name\":\"Petra\",\"birthdate\":\"1999-12-13\","
          ...
          + "\"bmi\":18.3},"
          + "{\"id\":3,\"name\":\"Hans\",\"birthdate\":\"1993-02-03\",\"weight\":75.7,\"height\":1.85,"
          + "\"bmi\":22.11},{\"id\":4,\"name\":\"Hugo\",\"birthdate\":\"1999-12-13\",\"weight\":78.0,\"height\":1.8,\"bmi\":24.07}],"
          + "\"returnMessage\":\"User has a BMI of 24.07 and therewith he has normal weight.\"}";
  ...
  public static final String USER_PETRA_DELETED_BY_NAME =
      "{\"result\":[{\"id\":2,\"name\":\"Torsten\",\"birthdate\":\"1985-12-05\",\"weight\":61.3,\"height\":1.83,"
          + "\"bmi\":18.3},"
          + "{\"id\":3,\"name\":\"Hans\",\"birthdate\":\"1993-02-03\",\"weight\":75.7,\"height\":1.85,"
          + "\"bmi\":22.11}],\"returnMessage\":\"User named Petra was deleted.\"}";
}
