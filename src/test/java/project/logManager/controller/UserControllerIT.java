...
class UserControllerIT {
    ...
    private static Stream<Arguments> getDeleteUserByNameArguments() {
        return Stream.of(
                ...
                Arguments.of("Actor not in database", false, "/user/delete/name/Petra", "ActorName", status().isInternalServerError(), String.format(ErrorMessages.USER_NOT_IDENTIFIED, "ActorName")),
