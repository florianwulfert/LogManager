...
class LogControlleIT{
        ...
        private Stream<Arguments> getLogsArgument() {
                ...
                return Stream.of(
                                ...
                                Arguments.of(
                                                "FilterLogsBySeverityAndStartTime", "INFO", null, jahr1999, null,
                                                status().isOk(), 2),
                                Arguments.of(
                                                "FilterLogsBySeverityAndEndTime", "INFO", null, null, jahr2005,
                                                status().isOk(), 2),
                                Arguments.of(
                                                "FilterLogsBySeverityAndMessage", "WARNING", "Warning", null, null,
                                                status().isOk(), 1),
                                Arguments.of(
                                                "FilterLogsByMessageAnStartTime", null, "Test", jahr1995, null,
                                                status().isOk(), 5),
                                Arguments.of(
                                                "FilterLogsByMessageAndEndTime", null, "Debug", null, jahr2015,
                                                status().isOk(), 1),
                                Arguments.of(
                                                "FilterLogsByStartTimeAndEndTime", null, null, jahr1999, jahr2005,
                                                status().isOk(), 5),
                                Arguments.of(
        ...
        class testSearchLogsById {
                ...
                void testGetLogsById() throws Exception {
                        MvcResult result = mockMvc.perform(get("/logs/1")).andDo(print()).andExpect(status().isOk())
                                        .andReturn();
                ...
                void testIdForGetLogsNotFound() throws Exception {
                        MvcResult result = mockMvc.perform(get("/logs/50")).andDo(print()).andExpect(status().isOk())
                                        .andReturn();
                ...
                void testIdForGetLogsHasWrongFormat() throws Exception {
                        ...
                        assertEquals(
                                        TestMessages.ID_FOR_LOGS_HAS_WRONG_FORMAT,
                                        result.getResponse().getContentAsString());
                }
        }
