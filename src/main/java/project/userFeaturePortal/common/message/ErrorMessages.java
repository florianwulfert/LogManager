package project.userFeaturePortal.common.message;
...
public class ErrorMessages {
  ...
  public static final String TITLE_IS_NOT_PRESENT =
      "Required String parameter 'titel' is not present";
  public static final String RELEASE_YEAR_IS_NOT_PRESENT =
      "Required Integer parameter 'erscheinungsjahr' is not present";
  ...
  public static final String USER_NOT_ALLOWED_DELETE_USER =
      "User %s has no authority to delete user.";
  public static final String USER_NOT_ALLOWED_CREATE_USER =
      "User %s has no authority to create user.";
