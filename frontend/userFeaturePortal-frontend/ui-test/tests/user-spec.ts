...
import {below, checkBox, click, closeBrowser, evaluate, goto, into, link, openBrowser, press, text, textBox, toLeftOf, write} from 'taiko';
...
export default class UserSpec {
  ...
  @Step("Login")
  public async login() {
    await write('Eugen', into(textBox(below('Sign'))));
    await click('Apply');
  }
  ...
  public async updateUser() {
    await console.log("update User");
  }

  @Step("Delete User")
  public async deleteUser() {
    await console.log("delete User");
  }
