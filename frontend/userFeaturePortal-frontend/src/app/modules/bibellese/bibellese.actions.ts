...
import {GetBooksErrorResponse, GetBibelleseResponse} from "./getBibellese/get-bibellese-response";
...
export const getBooksResponseAction = createAction('Get list of books', props<GetBibelleseResponse>())
